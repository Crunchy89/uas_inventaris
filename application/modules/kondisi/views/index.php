<div class="row">
	<div class="sixteen wide column">
		<div class="ui segments">
			...
			<div class="ui segment">
				<a href="<?= site_url('kondisi/tambah') ?>" class="ui primary vertical animated button" tabindex="0">
				...
				<table id="data_table" class="ui compact selectable striped celled table dataTable no-footer">
					...
					<tbody>
						...
						foreach ($kondisi as $row) { ?>
							<tr>
								...
								<td>
									<form action="<?= site_url('kondisi/edit') ?>" method="post">
										...
										<div onclick="hapus(<?= $row->id_kondisi ?>)" class="ui red horizontal animated button" tabindex="0">
							...
							<div class="ui basic modal" id="hapus<?= $row->id_kondisi ?>">
