<div class="row">
	<div class="sixteen wide column">
		<div class="ui segments">
			...
			<div class="ui segment">
				<a href="<?= site_url('sumber/tambah') ?>" class="ui primary vertical animated button" tabindex="0">
				...
				<table id="data_table" class="ui compact selectable striped celled table dataTable no-footer">
					...
					<tbody>
						...
						foreach ($sumber as $row) { ?>
							<tr>
								...
								<td>
									<form action="<?= site_url('sumber/edit') ?>" method="post">
										...
										<div onclick="hapus(<?= $row->id_sumber ?>)" class="ui red horizontal animated button" tabindex="0">
							...
							<div class="ui basic modal" id="hapus<?= $row->id_sumber ?>">
